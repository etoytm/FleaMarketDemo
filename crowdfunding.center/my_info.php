...
<div class="my_info_content">
    <table class="my_info_content_care_table">
        ...
        <tr>
            ...
            <td class="color555"><?php echo $uid ?></td>
        </tr>
        <tr>
            <td align="right" class="color555">手手机号码：</td>
            <td class="color555">18609515574<span class="color959595 margin_left10 font_size12">友好提示：网站前台不会显示您手机号，用于运营人员替您办理投融资手续</span>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="color555"><span class="color959595 margin_left10 font_size12">友情提示：网站不会显示您的身份信息，在有限合伙企业设立时会用到您的身份信息</span>
            </td>
        </tr>
        <tr>
            <td align="right" class="color555">个人名片：</td>
            <td class="color555"><img id="cardimg" width="215" height="110"
                                      src="../img/member_center/carddefault.jpg"></img>
                <input class="my_info_content_care_table_file" name="" type="file"></td>
        </tr>
        <tr>
            <td align="right" class="color555">&nbsp;</td>
            <td class="color555"><span
                        class="color959595 margin_left10 font_size12">友情提示：便于投融双方了解到您的相关信息，从而促进项目尽快达成</span></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="color555">最小投资金额
                ...
                <span class="color959595 margin_left10 font_size12">请您如实填写</span><span
                        class="colorCA1E37 margin_left10 font_size12">友好提示:投资有风险,入股需谨慎!</span></td>
        </tr>
        <tr>
            ...
            <td class="color555">
                <div id="my_city">
                    ...
                    <span class="color959595 margin_left10 font_size12">友好提示：我们能更好的为您融资做出更多针对性投融需求服务</span></div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="right" class="color555">&nbsp;</td>
            <td class="color555"><span class="color959595 margin_left10 font_size12">友好提示：网站前台页面不会显示您的地址，用于某经融公司众筹平台运营管理人员替您办理入股工商变更手续及快递接收</span>
            </td>
        </tr>
        <tr>
