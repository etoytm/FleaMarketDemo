...
function listClick(value) {
    ...
    if (value == 12) {
        ...
        $("#crowdfunding_iframe").attr("src", "crowdfunding.center/integration_record.html");
        $("#crowdfunding_iframe").attr("height", "1045");
        $("#vertical_navigation").css("height", "1050px");
    ...
    if (value == 13) {
        ...
        $("#crowdfunding_iframe").attr("src", "crowdfunding.center/integration_rule.html");
        $("#crowdfunding_iframe").attr("height", "1045");
        $("#vertical_navigation").css("height", "1050px");
    ...
    if (value == 16) {
        $("#crowdfunding_iframe").attr("src", "crowdfunding.center/outbox.html");
        $("#crowdfunding_iframe").attr("height", "1045");
        $("#vertical_navigation").css("height", "1050px");
